    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=120, null=True, unique=True, verbose_name='Почта')),
                ('is_verified', models.BooleanField(default=False, verbose_name='Верифицирован')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='media/avatars/%Y/%m/%D/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'webp'])], verbose_name='Аватар')),
